...
from old_data.ArXiv.config import DB_PATH, DATA_DIR, PROJECT_ROOT, RESULTS_DIR
from old_data.ArXiv.scripts.utils.category_hierarchy import extract_main_category
